...
public class GameScreen extends Screen {
	...
	public GameScreen(Game game) {
		...
		robot = new Robot();
		hb = new Heliboy(600, 360);
		hb2 = new Heliboy(900, 360);
		...
		// Defining a paint object. This lines of code are used in order to project the background.
    ...
    // This section of code defines a method that allows us to load the map that is needed.
	...
	private void loadMap() {
		...
		Scanner scanner = new Scanner(RobotGame.map);
	...
	private void updateRunning(List touchEvents, float deltaTime) {
		...
		ArrayList projectile = robot.getProjectiles();
